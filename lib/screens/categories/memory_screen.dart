...
class _MemoryScreenState extends State<MemoryScreen> {
  ...
  void _getTimes() async {
    ...
    if (_sp.getString('Theme') == 'light' && MemoryScreen._theme != 'light') {
      _changeTheme();
    }
    setState(() {});
  }
  ...
  void _changeTheme() async {
    setState(() {
      MemoryScreen._theme = (MemoryScreen._theme == 'dark') ? 'light' : 'dark';
    });
    SharedPreferences _sp = await SharedPreferences.getInstance();
    _sp.setString('Theme', MemoryScreen._theme);
  }
                                    ...
                                    onTap: () {
                                      if ((_first == -1 || _second == -1) &&
                                        ...
                                        Timer(
                                            const Duration(
                                                milliseconds:
                                                    210), // turnover duration of the cards
                                            () {
                                          _colors[index].value =
                                              (_colors[index].value ==
                                                      Colors.transparent)

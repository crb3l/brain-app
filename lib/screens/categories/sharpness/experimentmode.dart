...
import 'package:bigbrain/screens/categories/sharpness/experimentmode_2.dart';
...
class _ExperimentModeState extends State<ExperimentMode>
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: (_medium == Colors.grey.shade900)
                    ? <Color>[
                        HSLColor.fromColor(const Color(0xFF121212))
                            .withLightness(
                                HSLColor.fromColor(const Color(0xFF121212))
                                        .lightness *
                                    (1.15))
                  ...
                  SizedBox(
                    ...
                    child: Container(
                      ...
                      child: FloatingActionButton(
                        ...
                        child:
                            const Icon(Icons.color_lens_outlined, size: 42.0),
                      ),
                    ),
                  ),
                  Container(
                            ...
                            transitionBuilder: (BuildContext context,
                              ...
                              return FadeTransition(
                                opacity: CurvedAnimation(
                                        parent: anim1, curve: Curves.easeInOut)
                                    .drive(
                                        Tween<double>(begin: 0.15, end: 1.0)),
                                child: ScaleTransition(
                                  scale: CurvedAnimation(
                                          parent: anim1,
                                          curve:
                  ...
                  FloatingActionButton.extended(
                    ...
                    onPressed: () {
                      Navigator.of(context).pushReplacement(MyRoute(
                          builder: (BuildContext context) =>
                              ExperimentMode2(widget._displayAd)));
                    },

...
class PictureMode extends StatefulWidget {
  const PictureMode(this._picture, this._displayAd, {Key? key})
      : super(key: key);
  final int _picture;
            ...
            Timer(const Duration(milliseconds: 800), () {
              ...
              Timer(const Duration(milliseconds: 1400), () {
                ...
                if (_moveCnt.value < _bestScore || _bestScore == -1) {
                  _sp.setInt(
                      '_pic${(widget._picture)}BestScore', _moveCnt.value);
                }
              });
            });
          });
      ...
      child: Stack(
        children: <Widget>[
                                          ...
                                          child: ClipRRect(
                                              borderRadius: BorderRadius.all(
                                                  Radius.circular(
                                                      _squareRadius)),
                                              child: Image.asset(
                                                  'assets/${widget._picture}/${_items[i][j]}.jpg')),
                                        ),
                                      ),
                                    ),
                                  ),
          ...
          Material(
            ...
            child: AnimatedAlign(
              duration: const Duration(seconds: 1),
              curve: (_originalImgAlignment == Alignment.topRight)
                  ? Curves.linearToEaseOut
                  : Curves.fastLinearToSlowEaseIn,
              ...
              child: AnimatedContainer(
                ...
                margin: (_originalImgAlignment == Alignment.topRight)
                    ? EdgeInsets.fromLTRB(0.0, (_size / 15), (_size / 40), 0.0)
                    : EdgeInsets.zero,
                transformAlignment: Alignment.center,
                transform: Matrix4.identity()
                  ..scale((_originalImgAlignment == Alignment.topRight)
                      ? 1.0
                      : 5.33),
                ...
                child: InkWell(
                  ...
                  onTap: () {
                    setState(() {
                      _originalImgAlignment =
                          (_originalImgAlignment == Alignment.topRight)
                              ? Alignment.center
                              : Alignment.topRight;
                    });
                  },
                  child: Hero(
                    ...
                    child: ClipRRect(
                      borderRadius:
                          BorderRadius.all(Radius.circular(_radius / 2)),
                      child: Image.asset(
                        'assets/${widget._picture}/original.jpg',

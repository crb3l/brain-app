...
class _ExperimentMode2State extends State<ExperimentMode2>
          ...
          title: ValueListenableBuilder<int>(
            ...
            builder: (BuildContext context, int value, Widget? child) {
              return Text('MOVES: $value',
                  style: TextStyle(fontSize: _textFontSize / 2));
            },
          ),
            ...
            FloatingActionButton.extended(
              ...
              onPressed: () {
                Navigator.of(context).pushReplacement(MyRoute(
                    builder: (BuildContext context) =>
                        ExperimentMode(widget._displayAd)));
              },
            ...
            RepaintBoundary(
              ...
              child: ImageFiltered(
                imageFilter: ImageFilter.blur(
                    sigmaX: 8.0, sigmaY: 8.0, tileMode: TileMode.decal),
                child: Image.asset(
                                    ...
                                    child: ValueListenableBuilder<List<int>>(
                                      ...
                                      builder: (BuildContext context,
                                        ...
                                        return AnimatedContainer(
                                          ...
                                          width: /*(_isShuffling) ? (_squareDimension / 1.5) :*/
                                              _squareDimension,
                                          height: /*(_isShuffling) ? (_squareDimension / 1.5) :*/
                                              _squareDimension,

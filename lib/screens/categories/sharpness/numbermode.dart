...
class _NumberModeState extends State<NumberMode>
  ...
  final ValueNotifier<int> _moveCnt = ValueNotifier<int>(0),
      _inPosition = ValueNotifier<int>(0);
  final List<Color> _colors = <Color>[
      ...
      _secondaryColors = <Color>[
        HSLColor.fromColor(Colors.redAccent.shade400)
            .withLightness(
                HSLColor.fromColor(Colors.redAccent.shade400).lightness *
                    (0.85))
            .toColor(),
        HSLColor.fromColor(Colors.blueAccent.shade400)
            .withLightness(
                HSLColor.fromColor(Colors.blueAccent.shade400).lightness *
                    (0.85))
            .toColor(),
        HSLColor.fromColor(Colors.deepOrangeAccent.shade400)
            .withLightness(
                HSLColor.fromColor(Colors.deepOrangeAccent.shade400).lightness *
                    (0.85))
            .toColor(),
        HSLColor.fromColor(Colors.lightGreenAccent.shade400)
            .withLightness(
                HSLColor.fromColor(Colors.lightGreenAccent.shade400).lightness *
                    (0.85))
            .toColor(),
        HSLColor.fromColor(Colors.pinkAccent.shade400)
            .withLightness(
                HSLColor.fromColor(Colors.pinkAccent.shade400).lightness *
                    (0.85))
            .toColor(),
        HSLColor.fromColor(Colors.purpleAccent.shade400)
            .withLightness(
                HSLColor.fromColor(Colors.purpleAccent.shade400).lightness *
                    (0.85))
            .toColor(),
        HSLColor.fromColor(Colors.greenAccent.shade400)
            .withLightness(
                HSLColor.fromColor(Colors.greenAccent.shade400).lightness *
                    (0.85))
            .toColor(),
        HSLColor.fromColor(Colors.tealAccent.shade400)
            .withLightness(
                HSLColor.fromColor(Colors.tealAccent.shade400).lightness *
                    (0.85))
            .toColor(),
        HSLColor.fromColor(const Color(0xFFFF9100))
            .withLightness(
                HSLColor.fromColor(const Color(0xFFFF9100)).lightness * (0.85))
            .toColor()
      ];
  late double _opacity = 0.0,
      ...
      _textShadow = 0.0,
      _textFontSize = 0.0;
  final List<int> _blankPosition = <int>[3, 3],
      _inversionControl = <int>[
        1,
        2,
        3,
        4,
  ...
  final List<List<ValueNotifier<List<int>>>> _margins =
      <List<ValueNotifier<List<int>>>>[
  ...
  final List<List<ValueNotifier<double>>> _hoverSize =
      <List<ValueNotifier<double>>>[
  ...
  Future<void> _fetch() async {
    ...
    setState(() {
      _colorCnt =
          (_sp.getInt('_colorCnt') != null) ? (_sp.getInt('_colorCnt')!) : 0;
    });
            ...
            child: AlertDialog(
              ...
              content: SingleChildScrollView(
                child: Text('Game Paused',
                    ...
                    style: TextStyle(fontSize: 20.0, color: _complement)),
              ),
              actions: <Widget>[
                Row(
        ...
        transitionBuilder: (BuildContext context, Animation<double> anim1,
          ...
          return FadeTransition(
            opacity: CurvedAnimation(parent: anim1, curve: Curves.easeInOut)
                .drive(Tween<double>(begin: 0.15, end: 1.0)),
  ...
  void _changeTheme() async {
    if (_opacity == 1.0) {
      ...
      showGeneralDialog(
        barrierDismissible: true,
        barrierLabel: '',
        barrierColor: (_medium == Colors.grey.shade900)
    ...
    if (_opacity == 1.0) {
      Timer(const Duration(milliseconds: 500), () {
        setState(() {
          _medium = (_medium == Colors.grey.shade900)
              ? const Color(0xFFE0E0E0)
              : Colors.grey.shade900;
          _complement = (_complement == Colors.white)
              ? Colors.grey.shade900
              : Colors.white;
        });
      ...
      setState(() {
        _medium = (_medium == Colors.grey.shade900)
            ...
            : Colors.grey.shade900;
        _complement =
            (_complement == Colors.white) ? Colors.grey.shade900 : Colors.white;
      });
    }
  }
  ...
  void _tap(int row, int col) async {
    ...
    if (actualCol == _blankPosition[1] || actualRow == _blankPosition[0]) {
        ...
        for (int j = 0; j < _items[i].length; j++) {
          ...
          if (actualCol == oldBlankPosition[1]) {
            ...
            if (actualRow < oldBlankPosition[0]) {
              // SLIDE TO BOTTOM
              if (_column == actualCol &&
                  _row <= oldBlankPosition[0] &&
                  _row >= actualRow) {
                _margins[i][j].value[1] += _movement;
                _margins[i][j].notifyListeners();
              }
      ...
      if (cnt == 15) {
                  ...
                  transitionBuilder: (BuildContext context,
                    ...
                    return FadeTransition(
                      opacity: CurvedAnimation(
                              parent: anim1, curve: Curves.easeInOut)
                          .drive(Tween<double>(begin: 0.15, end: 1.0)),
                      child: ScaleTransition(
                        scale: CurvedAnimation(
                                parent: anim1,
        ...
        await _player.setAsset('assets/TM.wav');
        _player.play();
      }
      _moveCnt.value++;
    } else {
  ...
  Widget build(BuildContext context) {
    if (_opacity == 0.0) {
      _size = (sqrt(MediaQuery.of(context).size.width) *
              sqrt(MediaQuery.of(context).size.height))
          .floor();
      if (MediaQuery.of(context).size.aspectRatio <= 1) {
        _size =
            (_size * sqrt(sqrt(sqrt(MediaQuery.of(context).size.aspectRatio))))
                .floor();
      } else {
        //_size = (_size / sqrt(MediaQuery.of(context).size.aspectRatio)).floor();
        _size = ((_size / sqrt(MediaQuery.of(context).size.aspectRatio)) / 1.25)
            .floor();
      }
      //_movement = _size ~/ 6;
      _movement = _size ~/ 5.5;
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: (_medium == Colors.grey.shade900)
                    ? <Color>[
                        HSLColor.fromColor(Colors.grey.shade900)
                            .withLightness(
                                HSLColor.fromColor(Colors.grey.shade900)
                                        .lightness *
                                    (1.15))
                    ...
                    : <Color>[
                        const Color(0xFFE0E0E0),
                        HSLColor.fromColor(const Color(0xFFE0E0E0))
                            .withLightness(
                                HSLColor.fromColor(const Color(0xFFE0E0E0))
                                        .lightness *
                                    (0.85))
                    ...
                    child: AlertDialog(
                      ...
                      content: SingleChildScrollView(
                        child: Text('Do you want to quit?',
                            textAlign: TextAlign.center,
                            style:
                                TextStyle(fontSize: 20.0, color: _complement)),
                      ),
                      actions: <Widget>[
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                ...
                title: ValueListenableBuilder<int>(
                  ...
                  builder: (BuildContext context, int value, Widget? child) {
                    return Text('MOVES: $value',
                        style: TextStyle(
                            fontSize: _textFontSize / 2, color: _complement));
                  },
                ),
                          ...
                          pageBuilder: (BuildContext context,
                            ...
                            return WillPopScope(
                              ...
                              child: AlertDialog(
                                ...
                                content: SingleChildScrollView(
                                  child: Text('Do you want to restart?',
                                      textAlign: TextAlign.center,
                                      style: TextStyle(
                                          fontSize: 20.0, color: _complement)),
                                ),
                                actions: <Widget>[
                                  Row(
                                    mainAxisAlignment:
                  ...
                  child: Stack(
                    children: <Widget>[
                      ConstrainedBox(
                        ...
                        child: Container(
                          padding: (_centerSquareDimension == 0)
                              ? EdgeInsets.all((_size / 60))
                              : EdgeInsets.only(
                                  left: (_size / 60), top: (_size / 60)),
                          ...
                          decoration: ShapeDecoration(
                            ...
                            shadows: <BoxShadow>[
                              BoxShadow(
                                color: (_medium == Colors.grey.shade900)
                                    ? Colors.white12
                                    : Colors.white,
                                                              ...
                                                              color: (value[
                                                                  ...
                                                                  ? HSLColor.fromColor(
                                                                          _colors[
                                                                              _colorCnt])
                                                                      .withLightness(
                                                                          HSLColor.fromColor(_colors[_colorCnt]).lightness *
                                                                              (1.35))
                                                                      .toColor()
                                                                  : ((_medium ==
                                                                          Colors
